import React, { useRef, useDebugValue, useContext, createElement, memo, forwardRef, useState, Children, useCallback, useEffect, Fragment as Fragment$3 } from 'react';
...
var Avatar = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(StyledAvatar, __assign({ ref: ref, size: size }, props), isValidURL(res) ? createElement("img", { src: res }) : createElement("span", null, chars(res))));
}));
...
var Text$1 = memo(forwardRef(function (_a, ref) {
    ...
    return (createElement(Text, __assign({ textSize: textSize, textWeight: textWeight, textAlign: textAlign, ref: ref }, restProps), children));
}));
Text$1.defaultProps = {
    lineThrough: false,
    uppercase: false,
...
var Button = memo(forwardRef(function (props, ref) {
    ...
    return createElement(StyledButton, __assign({ ref: ref, type: type, size: size }, props),
        createElement(Text$1, { textSize: textSize, textColor: textColor, hoverColor: hoverTextColor }, props.children));
}));
...
var Card$1 = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(Card, __assign({ ref: ref }, props),
        imgSrc && createElement(CardHeader, __assign({}, props),
            createElement(CardImage, { src: imgSrc })),
        createElement(CardBody, __assign({}, props),
            createElement(CardTitle, null,
                createElement(Text$1, { textColor: titleColor, textSize: titleSize }, title)),
            createElement(CardDescription, null,
                createElement(Text$1, { textColor: descriptionColor, textSize: descriptionSize }, description)))));
}));
Card$1.defaultProps = {
    textAlignment: 'left',
    variant: 'vertical'
...
var CardTable = memo(forwardRef(function (props, ref) {
    var thData = props.thData, tdData = props.tdData;
    return createElement(StyledTable, __assign({ ref: ref }, props),
        createElement(StyledThead, __assign({}, props),
            createElement(StyledTr, __assign({}, props), thData && thData.map(function (th) { return createElement(StyledTh, __assign({ key: th.id }, props), th.data); }))),
        createElement(StyledTbody, __assign({}, props), tdData && tdData.map(function (tr) { return createElement(StyledTr, __assign({ key: tr.trId }, props), tr.trData.map(function (td) { return createElement(StyledTd, __assign({ key: td.tdId }, props), td.tdData); })); })));
}));
...
var CheckBox = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(CheckBoxWrapper, __assign({ ref: ref }, props),
        createElement(ErrorLabel, { id: "error", htmlFor: "error" }, errorText),
        createElement(StyledLabel, __assign({ size: size }, props),
            createElement("input", { type: "checkbox", checked: checked ? checked : check, value: value === '' ? label : value, onChange: function () { return setCheck(!check); } }),
            createElement(Text$1, { textSize: fontSize, textColor: labelColor, hoverEffect: labelHoverEffect, hoverColor: labelHoverColor }, label))));
}));
...
var CheckBoxGroup = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(CheckBoxWrapper, __assign({ ref: ref }, props),
        createElement(ErrorLabel, { id: "error", htmlFor: "error" }, errorText),
        createElement(StyledLabel$1, __assign({ size: size }, props),
            showSelectAll ? createElement("input", { type: "checkbox", checked: selectAll, onChange: function () { return setSelectAll(!selectAll); } }) : '',
            createElement(Text$1, { textSize: fontSize, textColor: labelColor, hoverEffect: labelHoverEffect, hoverColor: labelHoverColor }, label)),
        createElement(StyledUl, __assign({ display: display }, props), checkBoxOptions && checkBoxOptions.map(function (obj) {
            return (createElement(StyledLi, { key: obj.id },
                createElement(CheckBox, { key: obj.id, label: obj.label, value: obj.value, checked: obj.checked ? obj.checked : selectAll, size: size, fontSize: fontSize, labelColor: labelColor, hoverEffect: hoverEffect, labelHoverEffect: labelHoverEffect, labelHoverColor: labelHoverColor, disabled: obj.disabled ? obj.disabled : disabled, bgColor: bgColor, hoverBgColor: hoverBgColor, hoverShadowColor: hoverShadowColor, labelPosition: labelPosition })));
        }))));
}));
...
var FileInput = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(StyledWrapper, __assign({ ref: ref }, props),
        createElement(ErrorLabel, __assign({}, props), errorText),
        createElement(StyledLabel$2, __assign({}, props),
            createElement(BrowsSpan, __assign({ size: size }, props), "Browse"),
            createElement(FileNameSpan, __assign({ size: size }, props), file === '' ? 'Chose file' : file),
            createElement(StyledInput, { type: "file", onChange: handleUpload }))));
}));
...
var Input$1 = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(OuterWrapper, __assign({}, restProps),
        hasError && createElement(Text$1, { className: "error" }, errorText),
        createElement(InputWrapper, { fullWidth: fullWidth, borderColor: borderColor, textColor: textColor, hasError: hasError },
            preffix && createElement(Preffix, { preffixBackgroundColor: preffixBackgroundColor, preffixColor: preffixColor, hasError: hasError }, preffix),
            createElement(Input, __assign({ id: id, ref: ref, required: required, fullWidth: fullWidth, disabledColor: disabledColor, backgroundColor: backgroundColor, placeHolderColor: placeHolderColor, disabled: disabled }, restProps)),
            suffix && createElement(Suffix, { suffixBackgroundColor: suffixBackgroundColor, suffixColor: suffixColor, hasError: hasError }, suffix))));
}));
...
var Label$1 = memo(forwardRef(function (props, ref) { return (createElement(Label, __assign({ ref: ref }, props), props.children)); }));
...
var Link = memo(forwardRef(function (_a, ref) {
    ...
    return (createElement(LinkStyled, __assign({ href: href, ref: ref, linkSize: linkSize, linkColor: linkColor, hoverColor: hoverColor, activeColor: activeColor }, props), Children.map(props.children, function (c) {
        return isValidStringOrNumber(c) ? createElement(Text$1, { textSize: linkSize, textColor: linkColor, hoverColor: hoverColor, activeColor: activeColor, hoverEffect: true }, c) : c;
    })));
}));
...
var List = memo(forwardRef(function (props, ref) { return (createElement(ListStyled, __assign({ ref: ref }, props), Children.map(props.children, function (c, i) {
    return createElement("li", { key: i }, c);
}))); }));
...
var Modal$1 = function (_a) {
    ...
    return (createElement(Modal, { title: title, description: description, shadowColor: shadowColor, borderColor: borderColor, titleSize: titleSize, descriptionSize: descriptionSize },
        createElement(ModalHeader, { title: title, description: description, shadowColor: shadowColor, borderColor: borderColor, titleSize: titleSize, descriptionSize: descriptionSize },
            createElement(ModalTitle, null,
                createElement(Text$1, { textSize: titleSize, lineHeight: "1.5", textColor: titleColor }, title))),
        createElement(ModalBody, { title: title, description: description, shadowColor: shadowColor, borderColor: borderColor, titleSize: titleSize, descriptionSize: descriptionSize },
            createElement(ModalDescription, null,
                createElement(Text$1, { textSize: descriptionSize, textColor: descriptionColor }, description))),
        createElement(ModalFooter, { title: title, description: description, shadowColor: shadowColor, borderColor: borderColor, titleSize: titleSize, descriptionSize: descriptionSize })));
};
...
var Radio = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(RadioWrapper, null,
        createElement(ErrorLabel$1, { id: "error", htmlFor: "error" }, errorText),
        createElement(StyledLabel$3, __assign({ ref: ref, size: size, onChange: function () { return setSelect(!select); } }, props),
            createElement(Text$1, { className: 'radioLabel', hoverEffect: labelHoverEffect, hoverColor: hoverLabelColor, textSize: size, textColor: labelColor }, label),
            createElement("input", { type: "radio", value: value === '' ? label : value, checked: checked || select }),
            createElement(RadioSpan, __assign({}, props)))));
}));
...
var RadioGroup = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(StyledWrapper$1, __assign({ ref: ref }, props),
        createElement(ErrorLabel$2, null, errorText),
        createElement(RadioGroupWrapper, __assign({}, props),
            createElement(Text$1, { className: 'radioGroupLabel', textColor: labelColor, hoverColor: hoverLabelColor, hoverEffect: labelHoverEffect, textSize: size }, mainLabel),
            createElement(StyledUl$1, __assign({}, props), options && options.map(function (obj) {
                return (createElement(StyledLi$1, { key: obj.id },
                    createElement(Radio, { label: obj.label, value: obj.value, checked: select == obj.value, onChange: handleChange, size: size, labelHoverEffect: labelHoverEffect, labelColor: labelColor, hoverLabelColor: hoverLabelColor, hoverEffect: hoverEffect, bgColor: bgColor, hoverCheckedBgColor: hoverCheckedBgColor, hoverBgColor: hoverBgColor, checkedBgColor: checkedBgColor, labelPosition: labelPosition })));
            })))));
}));
...
var Table = memo(forwardRef(function (props, ref) {
    var thData = props.thData, tdData = props.tdData;
    return createElement(StyledTable$1, __assign({ ref: ref }, props),
        createElement(StyledThead$1, null,
            createElement(StyledTr$1, __assign({}, props), thData && thData.map(function (th) { return createElement(StyledTh$1, __assign({ key: th.id }, props), th.data); }))),
        createElement(StyledTbody$1, null, tdData && tdData.map(function (tr) { return createElement(StyledTr$1, __assign({ key: tr.trId }, props), tr.trData.map(function (td) { return createElement(StyledTd$1, __assign({ key: td.tdId }, props), td.tdData); })); })));
}));
...
var Toast$1 = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(ToastContainer, __assign({ ref: ref, variant: variant }, restProps),
        createElement(Toast, __assign({ variant: variant }, restProps),
            createElement(ToastHeader, __assign({}, props),
                createElement(Text$1, { textSize: "S", textColor: titleColor ? titleColor : color }, title)),
            createElement(ToastBody, null,
                createElement(Text$1, { textSize: "XS", textColor: messageColor ? messageColor : color }, message)))));
}));
...
var Toggle = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(ToggleWrapper, { size: size, disabled: restProps.disabled },
        createElement(Checkbox, __assign({ ref: ref, size: size, required: required, onChange: changeHandler }, restProps)),
        createElement(Circle, { size: size })));
}));
...
var Navbar = memo(forwardRef(function (props, ref) {
    ...
    return (createElement(StyledHeader, __assign({ ref: ref }, props),
        Logo &&
            createElement(StyledLogo, null, Logo),
        createElement(CSSTransition, { in: !isSmallScreen || isNavVisible, timeout: 350, classNames: "NavAnimation", unmountOnExit: true },
            createElement(StyledNav, __assign({}, props), navOptions && navOptions.map(function (obj, index) {
                return createElement("div", { key: index }, obj.option);
            }))),
        createElement(NavButton, { onClick: toggleNav, className: "Burger" },
            createElement(FontAwesomeIcon, { icon: faBars }))));
}));
...
var Sidenav = memo(forwardRef(function (props, ref) {
    var navOptions = props.navOptions, Logo = props.Logo;
    return (createElement(Fragment$3, null,
        createElement(StyledHeader$1, __assign({ ref: ref }, props, { id: "nav" }),
            createElement(StyledContent, null,
                Logo &&
                    createElement(StyledLogo$1, null,
                        Logo,
                        createElement("hr", null)),
                createElement(StyledNav$1, { className: "links" }, navOptions && navOptions.map(function (obj, index) {
                    return createElement("div", { key: index }, obj.option);
                })))),
        createElement(Wrapper, null,
            createElement("a", { className: "open", href: "#nav" },
                createElement(FontAwesomeIcon, { icon: faBars }),
                createElement("span", null, "Menu")),
            createElement("a", { className: "close", href: "#" },
                createElement(FontAwesomeIcon, { icon: faTimes }),
                createElement("span", null, "Close")))));
}));
...
var DotsCircle = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper, __assign({ ref: ref, size: size }, props),
        createElement(Loader, __assign({}, props))));
}));
...
var Loader$1 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$1, __assign({ ref: ref, size: size }, props),
        createElement(StyledLoader, __assign({}, props))));
}));
...
var Loader1 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$2, __assign({ ref: ref, size: size }, props),
        createElement(Loader$2, __assign({}, props))));
}));
...
var Loader10 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$3, __assign({ ref: ref, size: size }, props),
        createElement(Loader$3, __assign({}, props))));
}));
...
var Loader11 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$4, __assign({ ref: ref, size: size }, props),
        createElement(Loader$4, __assign({}, props))));
}));
...
var Loader12 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$5, __assign({ ref: ref, size: size }, props),
        createElement(Loader$5, __assign({}, props))));
}));
...
var Loader13 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$6, __assign({ ref: ref, size: size }, props),
        createElement(Loader$6, __assign({}, props))));
}));
...
var Loader14 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$7, __assign({ ref: ref, size: size }, props),
        createElement(Loader$7, __assign({}, props))));
}));
...
var Loader15 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$8, __assign({ ref: ref, size: size }, props),
        createElement(Loader$8, __assign({}, props))));
}));
...
var Loader16 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$9, __assign({ ref: ref, size: size }, props),
        createElement(StyledWrapper$2, __assign({}, props),
            createElement(Loader$9, __assign({}, props)))));
}));
...
var Loader17 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$a, __assign({ ref: ref, size: size }, props),
        createElement(StyledWrapper$3, __assign({}, props),
            createElement(Loader$a, __assign({}, props)))));
}));
...
var Loader18 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$b, __assign({ ref: ref, size: size }, props),
        createElement(StyledWrapper$4, __assign({}, props),
            createElement(Loader$b, __assign({}, props)))));
}));
...
var Loader19 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$c, __assign({ ref: ref, size: size }, props),
        createElement(StyledWrapper$5, __assign({}, props),
            createElement(Loader$c, __assign({}, props)))));
}));
...
var Loader2 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$d, __assign({ ref: ref, size: size }, props),
        createElement(Loader$d, __assign({}, props))));
}));
...
var Loader20 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$e, __assign({ ref: ref, size: size }, props),
        createElement(StyledWrapper$6, __assign({}, props),
            createElement(Loader$e, __assign({}, props),
                createElement("div", { className: "multi-spinner" },
                    createElement("div", { className: "multi-spinner" },
                        createElement("div", { className: "multi-spinner" },
                            createElement("div", { className: "multi-spinner" },
                                createElement("div", { className: "multi-spinner" },
...
var Loader3 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$f, __assign({ ref: ref, size: size }, props),
        createElement(Loader$f, __assign({}, props))));
}));
...
var Loader4 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$g, __assign({ ref: ref, size: size }, props),
        createElement(Loader$g, __assign({}, props))));
}));
...
var Loader5 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$h, __assign({ ref: ref, size: size }, props),
        createElement(Loader$h, __assign({}, props))));
}));
...
var Loader6 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$i, __assign({ ref: ref, size: size }, props),
        createElement(Loader$i, __assign({}, props))));
}));
...
var Loader7 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$j, __assign({ ref: ref, size: size }, props),
        createElement(Loader$j, __assign({}, props))));
}));
...
var Loader8 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$k, __assign({ ref: ref, size: size }, props),
        createElement(Loader$k, __assign({}, props))));
}));
...
var Loader9 = memo(forwardRef(function (props, ref) {
    var size = props.size;
    return (createElement(LoaderWrapper$l, __assign({ ref: ref, size: size }, props),
        createElement(Loader$l, __assign({}, props))));
}));
...
export { Avatar, Button, Card$1 as Card, CardTable, CheckBox, CheckBoxGroup, DotsCircle, FileInput, Input$1 as Input, Label$1 as Label, Link, List, Loader$1 as Loader, Loader1, Loader10, Loader11, Loader12, Loader13, Loader14, Loader15, Loader16, Loader17, Loader18, Loader19, Loader2, Loader20, Loader3, Loader4, Loader5, Loader6, Loader7, Loader8, Loader9, Modal$1 as Modal, Navbar, Radio, RadioGroup, Sidenav, Table, Text$1 as Text, Toast$1 as Toast, Toggle };
