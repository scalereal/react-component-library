...
var CardTable = React.memo(React.forwardRef(function (props, ref) {
    ...
    if (thData) {
        console.log(100 / (thData === null || thData === void 0 ? void 0 : thData.length));
    }
    return (React.createElement(StyledTable, __assign({ ref: ref }, props),
        ...
        React.createElement(StyledTbody, __assign({}, props), tdData && tdData.map(function (tr) { return React.createElement(StyledTr, __assign({ key: tr.trId }, props),
            " ",
