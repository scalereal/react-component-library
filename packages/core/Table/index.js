...
var Table = React.memo(React.forwardRef(function (props, ref) {
    ...
    return React.createElement(StyledTable, __assign({ ref: ref }, props),
        ...
        React.createElement(StyledTbody, null, tdData && tdData.map(function (tr) { return React.createElement(StyledTr, __assign({ key: tr.trId }, props), tr.trData.map(function (td) { return React.createElement(StyledTd, __assign({ key: td.tdId }, props), td.tdData); })); })));
}));
