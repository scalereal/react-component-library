...
export var StyledAvatar = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    ", "\n    ", "\n    display:", ";\n    border-radius: 50%;\n    text-align:center;\n    background-color: ", ";\n\n    ", "\n\n    img{\n        border-radius: 50%;\n    }\n    \n    span{\n        display: inline-block;\n        vertical-align: middle;\n        line-height: normal;\n        color: ", ";\n    }\n"], ["\n    ", "\n    ", "\n    display:", ";\n    border-radius: 50%;\n    text-align:center;\n    background-color: ", ";\n\n    ",
    "\n\n    img{\n        border-radius: 50%;\n    }\n    \n    span{\n        display: inline-block;\n        vertical-align: middle;\n        line-height: normal;\n        color: ", ";\n    }\n"])), function (pr) { return pr.disabled === true ? 'pointer-events: none;opacity: 0.4;' : ''; }, function (pr) { return mixin(pr.size); }, function (pr) { return pr.display !== 'block' ? pr.display : 'block'; }, function (pr) { return pr.bgColor || avatarTheme.defaults.bgColor; }, function (pr) { return pr.hoverEffect ? "&:hover {\n        background-color: " + (pr.hoverBgColor || avatarTheme.defaults.hoverBgColor) + ";\n        box-shadow: 0px 5px 8px " + (pr.hoverShadowColor || avatarTheme.defaults.shadowColor) + ";\n        span{\n            color: " + (pr.hoverTextColor || avatarTheme.defaults.hoverTextColor) + ";\n            text-shadow: 0px 5px 8px " + pr.hoverTextShadowColor + ";\n        }\n        }\n        " :
