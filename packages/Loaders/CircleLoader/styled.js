...
export var LoaderWrapper = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    ", "\n    ", "\n    display: ", ";\n    ", "{\n        border-left-color:  ", ";\n        border-right-color:  ", ";\n    }\n"], ["\n    ", "\n    ", "\n    display: ", ";\n    ", "{\n        border-left-color:  ", ";\n        border-right-color:  ", ";\n    }\n"])), function (pr) { return pr.disabled === true ? 'pointer-events: none;opacity: 0.4;' : ''; }, function (pr) { return mixin(pr.size); }, function (pr) { return pr.display ? 'inline-block' : 'none'; }, Loader, function (pr) { return pr.Color ? pr.Color : 'inherit'; }, function (pr) { return pr.Color ? pr.Color : 'inherit'; });
